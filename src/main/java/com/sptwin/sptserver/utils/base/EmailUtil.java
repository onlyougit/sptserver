package com.sptwin.sptserver.utils.base;
...
public class EmailUtil {
	 ...
	 */
	public static void sendActiveEmial(Address[] address, String validateUrl)
		...
		sendEmail(title, email, address, EMAIL_ADDRESS, EMAIL_AUTHORIZATION_CODE);
	}
	 ...
	 * @throws MessagingException
	 */
	public static void sendCodeEmail(String title, Address[] address, String content)
			throws GeneralSecurityException, MessagingException {
		sendEmail(title, content, address, EMAIL_ADDRESS, EMAIL_AUTHORIZATION_CODE);
	}

	static void sendEmail(String subject, String content, Address[] address, String formEmail, String password)
			throws GeneralSecurityException, MessagingException {
